...
`bryanunitek/UniCORE.MinIO` is the **MinIO** family member: On-prem-deployment-shape public gift surface. Documentation today; source code at certification.

**Family purpose:** Open-source S3-compatible object storage — file attachments, backups, filedrop storage for UniCORE.GVB.

---

## Upstream

- **Upstream project:** https://github.com/minio/minio
...
UniCORE.MinIO is published as a **four-repo family**:

- `bryanunitek/UniCORE.MinIO` — public on-prem-deployment-shape gift surface ← **this repo**
- `bryanunitek/UniSaaS.UniCORE.MinIO` — public SaaS-deployment-shape gift surface
- `bryanunitek/UniCORE.MinIO-Claw` (private) — on-prem-shape working repository
- `bryanunitek/UniSaaS.UniCORE.MinIO-Claw` (private) — SaaS-shape working repository
...
- **Public discussion:** [GitHub Discussions](https://github.com/bryanunitek/UniCORE.MinIO/discussions)
